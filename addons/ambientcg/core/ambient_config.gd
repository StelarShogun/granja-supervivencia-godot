...
const DEFAULT_DOWNLOAD_PATH = "res://addons/ambientcg/temp"
const DEFAULT_EXTRACT_PATH = "res://addons/ambientcg/extracted"
const DEFAULT_MATERIAL_DIR = "res://addons/ambientcg/materials"
const DEFAULT_ENVIRONMENT_DIR = "res://addons/ambientcg/environments"
