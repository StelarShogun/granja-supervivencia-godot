...
func _ready() -> void:
	...
	$Panel/MenuButtons/NewGameButton.pressed.connect(_on_new_game_pressed)
	$Panel/MenuButtons/KojimaButton.pressed.connect(_on_kojima_pressed)
...
func _on_new_game_pressed() -> void:
	SaveManager.game_mode = 0
	SaveManager.delete_save()
	SaveManager.pending_save_data = {}
	get_tree().change_scene_to_file("res://scenes/levels/main.tscn")


func _on_kojima_pressed() -> void:
	SaveManager.game_mode = 1
	SaveManager.delete_save()
	SaveManager.pending_save_data = {}
	get_tree().change_scene_to_file("res://scenes/levels/main.tscn")
